        ...
        <div class="col-ms-auto">
            <div class="card w-60 mb-3 mx-auto" style="width: 900px;">
                <div class="card-header text-light" style="background-color: #0040ff;">
                    <h4 class="text-start fs-5 fw-bold">LPP Saat Ini</h4>
                </div>
                <div class="card-body">
                    <form method="get" action="tampillpp" target="_blank" role="form" class="form-inline">
                        <div class="row">
                            <div class="col-sm-4">
                                <label class="fw-bold">Lokasi Stock</label>
                                <select class="form-select form-select-sm mb-3" name="stok" id="stok" style="font-size: 14px; width: 250px;">
                                ...
                                <select class="form-select form-select-sm mb-3" name="grup" id="grup" style="font-size: 14px; width: 250px;" disabled>
                                ...
                                <select class="form-select form-select-sm" name="statustag" id="statustag" style="font-size: 14px; width: 250px;">
                                ...
                                <select class="form-select form-select-sm mb-3" name="statusqty" id="statusqty" style="font-size: 14px; width: 250px;">
                                    <option value="All">All</option>
                            ...
                            <div class="col-sm-4">
                                ...
                                <select class="form-select form-select-sm mb-3" name="divisi" id="divisi" style="font-size: 14px; width: 250px;">
                                ...
                                <select class="form-select form-select-sm mb-3" name="dep" id="dep" style="font-size: 14px; width: 250px;">
                                ...
                                <select class="form-select form-select-sm mb-3" name="kat" id="kat" style="font-size: 14px; width: 250px;">
                            ...
                            <div class="col-sm-4">
                                ...
                                <select class="form-select form-select-sm mb-3" name="lap" id="lap" style="font-size: 14px; width: 250px;">
