...
<div class="container-fluid mt-3">
    <div class="row">
        <div class="col-sm-12">
            <div class="alert-danger alert fw-bolder fs-5 d-flex justify-content-between">
            <?php 
		...
		?>
            <a class="btn btn-outline-danger" data-bs-toggle="offcanvas" href="#offcanvasExample" role="button" aria-controls="offcanvasExample">
            Menu
            </a>
            </div>
        </div>
