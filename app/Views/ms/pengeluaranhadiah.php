            ...
            <div class="card w-100 mb-3">
                ...
                <div class="card-body">
                    <form method="get" action="/ms/pengeluaranhadiah">
                        <?= csrf_field(); ?>
                        <label class="fw-bold mb-2" for="prd">PERIODE :</label>
                        ...
                        <button type="submit" name="tombol" value="btngift1" class="btn w-100 mb-2 d-block text-light fw-bold" style="background-color: #0040ff;">Detail</button>
                        <button type="submit" name="tombol" value="btngift2" class="btn w-100 mb-2 d-block text-light fw-bold" style="background-color: #00b300;">Rekap</button>
                    </form>
                </div>
            </div>
        </div>
            ...
            <?php if(!empty($detail)) {?>
                <div class="card w-100 mb-3">
                    <div class="card-header text-dark" style="background-color: #00E6E6;">
                        <h6>Periode Data pengeluaran Hadiah : <?= date('d M Y',strtotime($awal)); ?> s/d <?= date('d M Y',strtotime($akhir)); ?></h6>
                    </div>
                    <div class="card-body">
                        ...
                        <table class="table mb-3">
                            ...
                            <tbody class="table-group-divider">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><?=$rk['KETERANGAN']; ?></td>
