        ...
        <div class="col-ms-auto">
            <div class="card w-60 mb-3 mx-auto" style="width: 900px;">
                <div class="card-header text-light" style="background-color: #0040ff;">
                    <h4 class="text-start fw-bold fs-5">Retur OMI</small></h4>
                </div>
                <div class="card-body">
                    <form method="get" action="tampilreturomi" target="_blank" role="form" class="form-inline">
                        <div class="row">
                            <!-- Kolom 1 -->
                            <div class="col-md-3" style="margin-left: 0.5px;">
                                <div class="card mb-1 ms-1" style="width: 280px;">
                                    <div class="card-header fw-bold" style="font-size: 16px;">Periode</div>
                                    <div class="card-body">
                            ...
                            <div class="col-md-3" style="margin-left: 70px;">
                                <div class="card mb-1 ms-1" style="width: 280px;">
                                    <div class="card-header fw-bold" style="font-size: 16px;">Document</div>
                                    <div class="card-body">
                                        <input type="text" name="noDocIgr" id="noDocIgr" class="w-100 mb-1 form-control input-sm" value="<?= old('noDocIgr'); ?>" placeholder="No Dokumen IGR" style="font-size: 14px;">
                                        <input type="text" name="noDocOmi" id="noDocOmi" class="w-100 mb-1 form-control input-sm" value="<?= old('noDocOmi'); ?>" placeholder="No Dokumen OMI" style="font-size: 14px;">
                                    </div>
                                </div>
                                <div class="card mb-1 ms-1" style="width: 280px;">
                                    ...
                                    <select class="form-select form-select-sm mb-3 mx-auto" name="jenisLaporan" id="jenisLaporan" style="font-size: 14px; width: 240px;">
                                        <option value="1">1. per Periode</option>
                                        <option value="2">2. per Tanggal</option>
                                        <option value="2B">2B. per Tanggal per OMI</option>
                                        <option value="3">3. per Nomor NRB</option>
                                        <option value="4">4. per Produk</option>
                                        <option value="4B">4B. per Produk per NRB</option>
