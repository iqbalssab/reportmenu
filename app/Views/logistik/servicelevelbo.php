        ...
        <div class="col-ms-auto">
            <div class="card w-60 mb-3 mx-auto" style="width: 900px;">
                <div class="card-header text-light" style="background-color: #0040ff;">
                    <h4 class="text-start fw-bold fs-5">Service Level 3 Periode<small> (Offtake atau Selling In)</small></h4>
                </div>
                <div class="card-body">
                    <form method="get" action="tampilslbo" target="_blank" role="form" class="form-inline">
                        <div class="row">
                            <!-- Kolom 1 -->
                            <div class="col-md-3" style="margin-left: 0.5px;">
                                <div class="card mb-1 ms-1" style="width: 280px;">
                                    ...
                                    <div class="card-body">
                                        <label class="fw-bold mb-2">Periode 1</label>
                                        <input type="date" name="awal1" id="awal1" class="w-100 mb-1 form-control" value="<?= old('awal1'); ?>" style="font-size: 14px;">
                                        <input type="date" name="akhir1" id="akhir1" class="w-100 mb-3 form-control" value="<?= old('akhir1'); ?>" style="font-size: 14px;">
                                        <label class="fw-bold mb-2">Periode 2</label>
                                        <input type="date" name="awal2" id="awal2" class="w-100 mb-1 form-control" value="<?= old('awal2'); ?>" style="font-size: 14px;">
                                        <input type="date" name="akhir2" id="akhir2" class="w-100 mb-3 form-control" value="<?= old('akhir2'); ?>" style="font-size: 14px;">
                                        <label class="fw-bold mb-2">Periode 3</label>
                                        <input type="date" name="awal3" id="awal3" class="w-100 mb-1 form-control" value="<?= old('awal3'); ?>" style="font-size: 14px;">
                                        <input type="date" name="akhir3" id="akhir3" class="w-100 mb-3 form-control" value="<?= old('akhir3'); ?>" style="font-size: 14px;">
                                    </div>
                                </div>
                            </div>
                            <!-- Kolom 2 -->
