...
<div class="container mt-3">
    <div class="row d-flex justify-content-center">
        <div class="col-md-6">
            <div class="card">
                <div class="card-header bg-primary text-center text-light pt-2">
                ...
                <div class="card-body p-2">
                    <form action="/store/salesperdep/tampilsalesperdep" method="post" target="_blank">
                        <fieldset class="p-2 border border-dark-subtle">
                            ...
                            <button type="submit" class="btn btn-primary text-light mt-3" name="btn" value="tampil">Tampil</button>
