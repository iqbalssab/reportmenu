        ...
        <div class="col-md-6">
            <div class="card w-50 mb-3 mx-auto">
                <div class="card-header text-light" style="background-color: #0040ff;">
                    ...
                    <small class="fw-light" style="color: yellow;">Direkomendasikan Cetak Data Terbaru Pada H + 1</small>
                </div>
                <div class="card-body">
                    <form method="get" action="tampildatachecker">
                        <?= csrf_field(); ?>
                        <label class="mb-2 fw-bold text-start" for="prd">TANGGAL :</label><br>
                        <input type="date" name="tgl" id="tgl" class="w-100 mb-4 form-control"  value="<?= old('tgl') ? old('tgl') : $now; ?>">
